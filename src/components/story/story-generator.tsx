...
export function StoryGenerator({
  ...
  useEffect(() => {
    if (!hydrated || !brainReady || story || loading) return;
    if (autoGeneratedRef.current) return;
    autoGeneratedRef.current = true;
    void handleGenerate();
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [hydrated, brainReady, story, loading, username]);
  ...
  const preparingStory =
    !story &&
    !loading &&
    (!hydrated || waitingForBrain || (brainReady && !error));
  ...
  return (
    <div className="space-y-6">
      ...
      {!story && !loading && hydrated && preparingStory && (
        <Reveal variant="enter" key="preparing">
        <Card className="bg-card shadow-hard">
          <CardContent className="flex flex-col items-center gap-4 py-10 text-center sm:py-12">
            ...
            <div className="max-w-md space-y-2">
              <h3 className="font-heading text-lg font-black tracking-normal uppercase">
                {waitingForBrain ? t.generator.waitingTitle : t.generator.emptyTitle}
              </h3>
